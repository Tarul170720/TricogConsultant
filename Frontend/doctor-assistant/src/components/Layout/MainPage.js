    ...
    <div className="container py-5">
      ...
      <div className="row justify-content-center">
        <div className="col-md-8 text-center">
          ...
          <button className="btn btn-primary mt-4 px-4 py-2" style={{fontSize: '1.1rem', backgroundColor: '#b32d2d', color: '#fff'}} onClick={() => useShowChatWindowStore.setState({ showChat: true })}>
            Chat with us
          </button>
        </div>
      </div>
